            ...
            child: Row(
              ...
              children: [
                ...
                Column(
                  children: [
                    Text(
                      oCcy.format(widget.hotel.price),
                      style: const TextStyle(
                        color: Colors.white,
                        fontSize: 24.0,
                        ...
                        children: [
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              Text(
                                  '${widget.hotel.acreage.toString()} m2',
                                  style: const TextStyle(
                                    fontSize: 14.0,
                                    fontWeight: FontWeight.bold,
                                    color: Color(0xff342861),
                        ...
                        children: [
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              Text(
                                  '${widget.hotel.mezzanine.toString()} m2',
                                  style: const TextStyle(
                                    fontSize: 14.0,
                                    fontWeight: FontWeight.bold,
                                    color: Color(0xff342861),
                        ...
                        children: [
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              Text(
                                  '${widget.hotel.maxPeople.toString()} người',
                                  style: const TextStyle(
                                    fontSize: 14.0,
                                    fontWeight: FontWeight.bold,
                                    color: Color(0xff342861),
                        ...
                        children: [
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              Text(
                                  '${widget.hotel.waterPrice.toString()} vnd',
                                  style: const TextStyle(
                                    fontSize: 14.0,
                                    fontWeight: FontWeight.bold,
                                    color: Color(0xff342861),
